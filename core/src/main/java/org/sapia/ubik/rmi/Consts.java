...
public interface Consts {
   ...
   * set the minimum number of consumer threads used to process remote events.
   */
   ...
   * set the size of the queue used to receive remote events. Defaults to 30 - beyond that number, 
